...
<body>
    ...
    <section id="mainSlider" class="slider">
            <div id="mainCaption" class="caption">
                <h1 class="basliksize">AY IŞIĞI SOKAĞI</h1> 
            </div>
    </section>
    ...
    <form id="form1" runat="server">
        <div class="okuma">
            <h2 class="yazi2"><b>AY IŞIĞI SOKAĞI ALINTILAR</b></h2>
            <p class="yazi1">
               " Hapsedildiği sürece gözyaşları insanın canını çok yakar. "-----
                ...
                Korkunun ecele faydası yok, çünkü ceza elle tutulur birşeydir.-----

                Hiçbir zaman yerine getiremeyeceğim bir şeye hemen söz verdim.-----

                Karşımda oturan yorgun bir insandı. Sanki sadece alışkanlığından öylece yaşayıp duruyor, duygusuz yaşamını gittiği yere kadar sürdürüyordu.-----
            </p>
        </div>
    </form>
